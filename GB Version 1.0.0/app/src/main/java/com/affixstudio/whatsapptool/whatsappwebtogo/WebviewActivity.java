...
public class WebviewActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(getResources().getColor(R.color.whats_web_cl, this.getTheme()));
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                if (url.toString().equals(WHATSAPP_HOMEPAGE_URL)){
                    ...
                    showToast(getString(R.string.app_name)+" has to be reloaded to keep the app running");
                    loadWhatsapp();
                    return true;
                    ...
                    if (intent.resolveActivity(getPackageManager()) != null) {
                        ...
                        Toast.makeText(WebviewActivity.this, "No application found to open this link", Toast.LENGTH_SHORT).show();
                        return true;
                    }
                }
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.appbar_hide) {
           ...
           logout();
            ...
            bid.showinfo(this,11,getString(R.string.fristInWebTeg));
        }
